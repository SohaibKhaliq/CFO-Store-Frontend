              ...
              <div className="mb-7">
                ...
                <div className="input-forms">
                  <div className="grid grid-cols-2 gap-[30px] mb-5">
                    ...
                    <div className="col-span-full w-full">
                      <div className="input-field h-auto relative">
                        <label
                          htmlFor="about"
                          className="text-sm text-white absolute rtl:left-auto rtl:right-3 ltr:left-3 ltr:right-auto -top-[9px] bg-black bg-opacity-30 inline-block px-[5px]"
                        >
                          About Me*
                        </label>
                        <textarea
                          ...
                          className="w-full h-[100px] text-white rounded-[5px] bg-[#0B0E12] border border-[#23262B] focus:outline-0 px-4 pt-6 focus:outline-none"
                        />
                      </div>
                      {errors && Object.hasOwn(errors, "about") ? (
                        <span className="text-sm mt-1 text-red-500">
                          {errors.about[0]}
                        </span>
                      ) : (
